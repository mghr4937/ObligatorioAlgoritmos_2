...
public class TestsSistemaV2 {
	...
	public void asignarUbicacionMovil() {
		...
		assertEquals(Retorno.Resultado.ERROR_1,
				sistema.asignarUbicacionMovil("IAA2211", -34.000000, -56.000000).resultado);
		// Esquina ya ocupada por otro movil
		assertEquals(Retorno.Resultado.ERROR_2,
				sistema.asignarUbicacionMovil("SAA1234", -34.909039, -56.195530).resultado);
		// Matricula no existe
		assertEquals(Retorno.Resultado.ERROR_3,
				sistema.asignarUbicacionMovil("NOE0000", -34.908880, -56.193299).resultado);
	}
	...
	public void testTramos() {
		...
		// Peso invalido
		assertEquals(Retorno.Resultado.ERROR_1,
				sistema.registrarTramo(-32.3105104, -58.0759192, -32.3105100, -58.0759192, -3).resultado);
		assertEquals(Retorno.Resultado.ERROR_1,
				sistema.registrarTramo(-32.3105104, -58.0759192, -32.3105100, -58.0759192, 0).resultado);
		...
		assertEquals(Retorno.Resultado.ERROR_2,
				sistema.registrarTramo(-32.3105200, -58.0759200, -32.3105104, -58.0759192, 80).resultado);
		assertEquals(Retorno.Resultado.OK,
				sistema.registrarTramo(-32.3105104, -58.0759192, -32.3105100, -58.0759192, 80).resultado);
		// Tramo duplicado
		assertEquals(Retorno.Resultado.ERROR_3,
				sistema.registrarTramo(-32.3105104, -58.0759192, -32.3105100, -58.0759192, 100).resultado);

		assertEquals(Retorno.Resultado.OK,
				sistema.registrarTramo(-32.3105100, -58.0759100, -32.3102222, -58.0759192, 180).resultado);
		assertEquals(Retorno.Resultado.OK,
				sistema.registrarTramo(-32.3105134, -58.0759162, -32.3105108, -58.0759152, 280).resultado);
		assertEquals(Retorno.Resultado.OK,
				sistema.registrarTramo(-32.3105108, -58.0759152, -32.3102202, -58.0759143, 380).resultado);
	...
	public void testEliminarTramos() {
		...
		// Eliminar tramo OK
		assertEquals(Retorno.Resultado.OK,
				sistema.eliminarTramo(-32.3105108, -58.0759152, -32.3102202, -58.0759143).resultado);
		// No existe una de las esquinas
		assertEquals(Retorno.Resultado.ERROR_1,
				sistema.eliminarTramo(-38.3105108, -51.0759152, -32.3102202, -58.0759143).resultado);
		// No existe tramo
		assertEquals(Retorno.Resultado.ERROR_2,
				sistema.eliminarTramo(-32.3105108, -58.0759152, -32.3102202, -58.0759143).resultado);
	...
	public void testMovilesEnRadio() {
		...
		assertEquals(Retorno.Resultado.OK,
				sistema.registrarTramo(-34.909039, -56.195530, -34.908951, -56.194500, 7).resultado);// P1-P2
		assertEquals(Retorno.Resultado.OK,
				sistema.registrarTramo(-34.909039, -56.195530, -34.909980, -56.195498, 2).resultado);// P1-P4
		assertEquals(Retorno.Resultado.OK,
				sistema.registrarTramo(-34.908951, -56.194500, -34.908880, -56.193299, 8).resultado);// P2-P3
		assertEquals(Retorno.Resultado.OK,
				sistema.registrarTramo(-34.908951, -56.194500, -34.909910, -56.194372, 12).resultado);// P2-P5
		assertEquals(Retorno.Resultado.OK,
				sistema.registrarTramo(-34.909813, -56.193202, -34.908880, -56.193299, 3).resultado);// P6-P3
		assertEquals(Retorno.Resultado.OK,
				sistema.registrarTramo(-34.909813, -56.193202, -34.909910, -56.194372, 18).resultado);// P6-P5
		assertEquals(Retorno.Resultado.OK,
				sistema.registrarTramo(-34.909813, -56.193202, -34.910728, -56.193116, 12).resultado);// P6-P9
		assertEquals(Retorno.Resultado.OK,
				sistema.registrarTramo(-34.909910, -56.194372, -34.909980, -56.195498, 2).resultado);// P5-P4
		assertEquals(Retorno.Resultado.OK,
				sistema.registrarTramo(-34.910913, -56.195370, -34.909980, -56.195498, 6).resultado);// P7-P4
		assertEquals(Retorno.Resultado.OK,
